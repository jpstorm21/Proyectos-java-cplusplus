...
public class TraductorApp {
    ...
    public static boolean aceptable(int etapa) {
        ...
        if (!diccionarios[solActual[etapa - 1]][solActual[etapa]]) //Retornamos falso
        {
            return false;
        } else //Si existe el diccionario, verificamos que no haya sido ingresado a la solución antes
        {
