...
public class BackTracking {
    ...
    public static boolean backtraking(char[][] tablero) {
        ...
        int columna = 0;
        int N = 0;
        int[] movFilas = {0, -1, 0, 1};
        int[] movColumnas = {-1, 0, 1, 0};
        int bombas = 0;
        return Recbacktracking(tablero, fila, columna, movFilas, movColumnas, N, bombas);
    }

    private static boolean Recbacktracking(char[][] tablero, int fila, int columna, int[] movFila, int[] movColumna, int n, int b) {
        ...
        if (testBomba(fila, columna, tablero)) {
            ...
            if (b < 4) { // con este if revisamos si no hemos usado todas las bombas
                ...
                return Recbacktracking(tablero, fila, columna, movFila, movColumna, n, b + 1);
            ...
            return Recbacktracking(tablero, fila, columna + 1, movFila, movColumna, n, b);
        } else if (fila < 5) {
            return Recbacktracking(tablero, fila + 1, 0, movFila, movColumna, n, b);
        } else {
    ...
    public static boolean testBomba(int fila, int col, char[][] tablero) {//esta funciona evalua las filas y columnas para ver donde puede colocar la bomba
    ...
    public static boolean comprobarZombies(char[][] tablero) {//comprueba si se encuentran zombies y retorna un boolean 
